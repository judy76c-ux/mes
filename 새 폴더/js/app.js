...
const App = (function() {
            ...
            if (contentArea) {
                contentArea.innerHTML = `
                    <div class="empty-state" style="margin-top:80px;">
                        ...
                        <h4>시스템 초기화 실패</h4>
                        <p style="color:var(--text-secondary);max-width:400px;text-align:center;">${error.message}</p>
                        ...
                        <div style="margin-top:24px;padding:16px;background:var(--bg-secondary);border-radius:8px;max-width:420px;font-size:0.82rem;color:var(--text-muted);text-align:left;">
                            ...
                            <br><br>
                            ⚠️ <em>DB 초기화 시 기존 데이터가 삭제됩니다.</em>
                        </div>
                    </div>
                `;
            }
    ...
    function registerModules() {
        ...
        Router.registerModule('sales-purchase', SalesPurchaseModule);
