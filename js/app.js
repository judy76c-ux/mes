...
const App = (function() {
    ...
    async function init() {
        ...
        try {
            ...
            Router.registerLazy(
                ...
                'js/modules/production_mgmt_v91.js?v=267',
                function() {
    ...
    function registerModules() {
        ...
        Router.registerModule('fire-safety-hub', FireSafetyHubModule);
        Router.registerModule('fire-facility-check', FireFacilityCheckModule);
    ...
    // 설정 화면(system 탭)의 LOT 수정 카드로 이동 + 스캔 결과가 보이도록 스크롤.
    // 대시보드의 오류 카드도 같은 목적지로 가야 하므로 공용 함수로 분리했다.
    function goToLotRepairTab() {
