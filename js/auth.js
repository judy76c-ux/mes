...
const AuthModule = (function () {
    ...
    const ALL_PAGES = [
        ...
        { id:'shipping-standby',          label:'출하 일상 검사',     group:'출하/제품' },
        { id:'shipping-inspection',       label:'출하검사 일지',      group:'출하/제품' },
        { id:'shipping-reliability',      label:'출하 신뢰성',        group:'출하/제품' },
    ...
    const PAGE_GROUPS = [
        ...
        { key:'quality',          label:'\uacf5\uc815\ud488\uc9c8',     pages:['prod-quality','prod-spc','spc-color','spc-film','spc-gloss','quality-performance','painting-quality-performance','improvement-activity','limit-samples','certifications-mgmt','cert-standard','cert-eval','cert-ledger','cert-multiskill-eval','cert-multiskill-analysis','gauge-rr-variable','gauge-rr-attribute','cert-status','inspectors-mgmt','operators-mgmt'] },
    ...
    const MENU_PERMISSION_SCOPES = {
        ...
        'shipping-overview': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-standby': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-inspection': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-reliability': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-certificate': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-standard': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
        'shipping-std-photo': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-certificate','shipping-standard','shipping-std-photo'],
