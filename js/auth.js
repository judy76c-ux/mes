...
const AuthModule = (function () {
    ...
    const PAGE_GROUPS = [
        ...
        { key:'shipping',         label:'\ucd9c\ud558\uac80\uc0ac',      pages:['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'] },
    ...
    const MENU_PERMISSION_SCOPES = {
        ...
        'shipping-overview': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
        'shipping-standby': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
        'shipping-inspection': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
        'shipping-reliability': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
        'shipping-standard': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
        'shipping-std-photo': ['shipping-overview','shipping-standby','shipping-inspection','shipping-reliability','shipping-standard','shipping-std-photo'],
